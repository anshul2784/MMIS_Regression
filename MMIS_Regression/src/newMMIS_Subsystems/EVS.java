...
public class EVS  extends Login{
	...
	@BeforeTest
    public void EVSStartup() throws Exception {
...
//					 " and rownum=1";
        ...
        sqlStatement="select id_medicaid from t_re_base b, t_re_aid_elig a"+
                ...
                " and a.cde_status1 <> 'H' and a.sak_cde_aid=140"+
                " and to_char(sysdate, 'YYYYMMDD') between a.dte_effective and a.dte_end"+
                " and not exists (select 1 from t_re_aid_elig where sak_recip=b.sak_recip"+
                " and cde_status1 <> 'H' and sak_cde_aid <> a.sak_cde_aid"+
                " and to_char(sysdate,'YYYYMMDD') between dte_effective and dte_end)"+
                " and not exists (select 1 from t_tpl_resource t, t_coverage_xref c"+
                " where t.sak_recip=b.sak_recip and t.sak_tpl_resource=c.sak_tpl_resource"+
                " and to_char(sysdate, 'YYYYMMDD') between c.dte_effective and c.dte_end)"+
                " and rownum<2";
...
//					 " and rownum=1";
	...
	public void RM_13_036() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_pmp_assign p, t_pmp_svc_loc l"+ 
					 ...
					 " and p.sak_pmp_ser_loc=l.sak_pmp_ser_loc and l.sak_prov=31494 and l.cde_service_loc='A'"+
					 " and rownum < 2";

		RMreset(sqlStatement);
		
		//Verify RM
		rmMessage="13 / 036 Prior Authorization Mandatory For All Care Except For Emergencies. Call Elder Service Plan-Cambridge Health Alliance at 617-575-5850.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	}
	...
	public void RM_29_495() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_aid_elig a"+
				" where b.sak_recip=a.sak_recip and ind_active='Y' and dte_death='0'"+
				" and a.cde_status1 <> 'H' and a.sak_cde_aid=144"+
				" and to_char(sysdate, 'YYYYMMDD') between a.dte_effective and a.dte_end"+
				" and not exists (select 1 from t_re_aid_elig where sak_recip=b.sak_recip"+
				" and cde_status1 <> 'H' and sak_cde_aid <> a.sak_cde_aid"+
				" and to_char(sysdate,'YYYYMMDD') between dte_effective and dte_end)"+
	...
	public void RM_40_601() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_elig e"+
					 " where b.sak_recip=e.sak_recip and ind_active='Y' and dte_death='0'"+
					 " and e.cde_status1<> 'H' and e.dte_end='22991231' and e.sak_pub_hlth=11"+
					 " and not exists (select 1 from t_re_elig e1 where e1.sak_recip=b.sak_recip and e1.cde_status1 <> 'H'"+
					 " and e1.dte_end='22991231' and e1.sak_pub_hlth <> e.sak_pub_hlth)"+
				 	 " and rownum < 2";
	...
	public void RM_76_525() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_pmp_assign p"+
					 " where b.sak_recip=p.sak_recip and ind_active='Y' and dte_death='0'"+
					 " and p.cde_status1 <> 'H' and p.sak_pub_hlth=34 and p.dte_end='22991231'"+
					 " and rownum < 2";

		RMreset(sqlStatement);
		
		//Verify RM
		rmMessage="76 / 525 For behavioral health service questions and authorization, call the Massachusetts Behavioral Health Partnership at 1-800-495-0086.";
		//Select BH tab
	...
	public void RM_461_461() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_pmp_assign p"+
					 " where b.sak_recip=p.sak_recip and ind_active='Y' and dte_death='0'"+
					 " and p.cde_status1 <> 'H' and p.sak_pub_hlth=23 and p.dte_end='22991231'"+
					 " and rownum=1";

		RMreset(sqlStatement);
		
		//Verify RM
		rmMessage="461 / 461 Primary Care Clinician Plan (PCC) Plan member. Call PCC for authorization for all services except those listed in 130 CMR 450.118(J).";
		//Select MC PCC tab
	...
	@Test
	public void RM_650() throws Exception {
		TestNGCustom.TCNo="RM_650";
		log("//TC "+TestNGCustom.TCNo);
        //Get member
		sqlStatement="select id_medicaid from t_re_base b, t_re_aid_elig e"+
					 " where b.sak_recip=e.sak_recip and ind_active='Y' and dte_death='0'"+
					 " and e.cde_status1 <> 'H' and e.dte_end='22991231' and e.sak_elig_start=3"+
					 " and not exists (select 1 from t_re_aid_elig where sak_recip=b.sak_recip and sak_aid_elig <> e.sak_aid_elig and dte_end='22991231' and sak_elig_start <> e.sak_elig_start)"+
					 " and rownum=1";

		RMreset(sqlStatement);
		
		//Verify RM
		rmMessage="MEMBER'S MASSHEALTH ELIGIBILITY IS TEMPORARY";
		rmCommon(rmMessage, eligTarget); 
	...
	public void RM_747_021() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_pmp_assign p, t_pmp_svc_loc l"+
				...
				" and p.sak_pmp_ser_loc=l.sak_pmp_ser_loc and l.sak_prov=25617 and l.cde_service_loc='D'"+
				" and rownum < 2";

		RMreset(sqlStatement);
		
		//Verify RM
		rmMessage="747 / 021 For medical service questions call BMC HealthNet Plan at 1-888-566-0010. For behavioral health service questions and authorizations call Beacon Health Strategies at 1-888-217-3501.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	...
	public void RM_749_021() throws Exception {
		...
		//Verify RM
		rmMessage="749 / 021 For medical service questions call BMC HealthNet Plan at 1-888-566-0010. For behavioral health service questions and authorizations call Beacon Health Strategies at 1-888-217-3501.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	...
	public void RM_773_500() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_pmp_assign p"+
				" where b.sak_recip=p.sak_recip and ind_active='Y' and dte_death='0'"+
				" and p.cde_status1 <> 'H' and p.dte_end='22991231' and p.sak_pub_hlth=29"+
				" and rownum < 2";

		RMreset(sqlStatement);
		
		//Verify RM
		rmMessage="773 / 500 Special program. Call Boston Medical Center HealthNet Plan at 1-888-566-0010 for authorizations.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	...
	public void RM_792_637() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_aid_elig e"+
				" where b.sak_recip=e.sak_recip and ind_active='Y' and dte_death='0'"+
				" and e.cde_status1 <> 'H' and e.sak_cde_aid=181 and to_char(sysdate, 'YYYYMMDD') between e.dte_effective and e.dte_end"+
				" and not exists (select 1 from t_re_aid_elig where sak_recip=b.sak_recip and cde_status1 <> 'H' and sak_cde_aid <> e.sak_cde_aid"+
				" and to_char(sysdate, 'YYYYMMDD') between dte_effective and dte_end)"+
				" and exists (select 1 from t_tpl_resource where sak_recip=b.sak_recip and to_char(sysdate, 'YYYYMMDD') between dte_effective and dte_end)"+
				" and rownum < 2";
...
//				  	 " and rownum=1";
	...
	public void RM_1059_618() throws Exception {
		...
		//Verify RM
		rmMessage="1059 / 618 BMC HealthNet Plan member. BMC HealthNet Plan is an MCO.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	...
	public void RM_1061_618() throws Exception {
		...
		//Verify RM
		rmMessage="1061 / 618 BMC HealthNet Plan member. BMC HealthNet Plan is an MCO.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	...
	public void RM_1136_616() throws Exception {
		...
		//Verify RM
		rmMessage="1136 / 616 Tufts Health Together member. Tufts Health Together is an MCO.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	...
	public void RM_1138_616() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_pmp_assign p, t_pmp_svc_loc l"+
				...
				" and p.cde_status1 <> 'H'"+
				" and to_char(sysdate, 'YYYYMMDD') between p.dte_effective and p.dte_end"+
				" and p.sak_pub_hlth=24 and p.sak_pmp_ser_loc=l.sak_pmp_ser_loc"+
		...
		//Verify RM
		rmMessage="1138 / 616 Tufts Health Together member. Tufts Health Together is an MCO.";
		//Select MC tab
		driver.findElement(By.xpath("//*[contains(@id, 'MCOList:0:providerName')]")).click();
		rmCommon(rmMessage, mcTarget); 
	...
	public void RM_956_611() throws Exception {
		...
		sqlStatement="select id_medicaid from t_re_base b, t_re_aid_elig a"+
				" where b.sak_recip=a.sak_recip and ind_active='Y' and dte_death='0'"+
				" and a.cde_status1 <> 'H' and a.sak_cde_aid=25 and a.dte_end='22991231'"+
				" and exists (select 1 from t_re_medicare_a where sak_recip=b.sak_recip and dte_end='22991231')"+
				" and exists (select 1 from t_re_medicare_b where sak_recip=b.sak_recip and dte_end='22991231')"+
				" and not exists (select 1 from t_re_aid_elig where sak_recip=b.sak_recip and sak_aid_elig <> a.sak_aid_elig and cde_status1 <> 'H' and dte_end='22991231')"+
				" and rownum < 2";
	...
	public static void RMreset(String sql) throws Exception {
	...
	public void connectorFullHSN(String aid, String msgNo) throws Exception {
        ...
        //Get member
		if (msgNo.equals("1509")) 
			sqlStatement="select id_medicaid from t_re_base b, t_re_aid_elig a"+
					 " where b.sak_recip=a.sak_recip and ind_active='Y' and dte_death='0'"+
					 " and a.cde_status1 <> 'H' and a.sak_cde_aid=315"+
					 " and to_char(sysdate, 'YYYYMMDD') between a.dte_effective and a.dte_end"+
					 " and not exists (select 1 from t_re_aid_elig where sak_recip=b.sak_recip"+
					 " and cde_status1 <> 'H' and sak_cde_aid <> a.sak_cde_aid"+
					 " and to_char(sysdate,'YYYYMMDD') between dte_effective and dte_end)"+
		...
		//Verify RM
		if (msgNo.equals("1509")) 
			rmMessage=msgNo+" / 675 Temporary Full HSN medical and dental are available. Member Eligible for ConnectorCare. If member is unenrolled, visit MAHealthConnector.org for more information.";
		else
	...
	public void connectorPartHSN(String aid, String msgNo) throws Exception {
        ...
        //Get member
		if (msgNo.equals("1527")) 
			sqlStatement="select id_medicaid from t_re_base b, t_re_aid_elig a"+
					 " where b.sak_recip=a.sak_recip and ind_active='Y' and dte_death='0'"+
					 " and a.cde_status1 <> 'H' and a.sak_cde_aid=316"+
					 " and to_char(sysdate, 'YYYYMMDD') between a.dte_effective and a.dte_end"+
					 " and not exists (select 1 from t_re_aid_elig where sak_recip=b.sak_recip"+
					 " and cde_status1 <> 'H' and sak_cde_aid <> a.sak_cde_aid"+
					 " and to_char(sysdate,'YYYYMMDD') between dte_effective and dte_end)"+
		...
		//Verify RM
		if (msgNo.equals("1527")) 
			rmMessage=msgNo+" / 677 Temporary Partial HSN medical and dental are available. Member Eligible for ConnectorCare. If member is unenrolled, visit MAHealthConnector.org for more information.";
		else
